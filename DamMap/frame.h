...
public:
	Frame(Mat &image, int erodeIterations = 48, int cannyThresh1 = 15, double cannyRatio = 45, int cannyAperture = 3, double darkThresh = 0.9, int redMinHue = 160, int redMaxHue = 200);
	~Frame();
